...
подготавливают GPU, Google Drive, код из ветки `codex/no-baseline-augmentation`, Cityscapes,
...
его из `last.pt` после обрыва runtime и дописывает ту же историю CSV.
